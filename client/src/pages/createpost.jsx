    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Share your thought with world</p>
        </div>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p text-sm text-gray-500>@{user.username}</p>
            </div>
          </div>
            ...
            images.length > 0 && <div className='flex flex-wrap gap-2 mt-4'>
              {images.map((image, i) => (
                <div key={i} className='relative group'>
                  <img src={URL.createObjectURL(image)} className='h-20 rounded-medium' alt="" />

                  <div
                    onClick={() => setImages(images.filter((_, index) => index !== i))}
                    className="absolute inset-0 bg-black/40 rounded-md hidden group-hover:flex 
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            <button
              ...
              onClick={() =>
                toast.promise(
                  handleSubmit(),   // must return a real promise
                  {
                    loading: 'Uploading ...',
