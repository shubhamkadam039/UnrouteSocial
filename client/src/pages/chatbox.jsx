    ...
    <div className='flex flex-col h-screen'>
      ...
      <div className='px-4'>
        <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5'>
          <input type="text" className='flex-1 otline-none text-slate-700' placeholder='Type a message...' 
          ...
          <button onClick={sendMessage} className='bg-linear-to-br from-orange-500 to-orange-600 hover:from-orange-700 hover:to-orange-800 active:scale-95 cursor-pointer text-white p-2 rounded-full'>
