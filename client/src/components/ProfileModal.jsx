                ...
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                        ...
                        <div>
                            ...
                            <input type="text" className='w-full p-3 border-gray-200 rounded-lg' placeholder='Please enter your full name' onChange={(e)=>setEditForm({...editForm, full_name: e.target.value})} value={editForm.full_name}/>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" className='w-full p-3 border-gray-200 rounded-lg' placeholder='Please enter a username' onChange={(e)=>setEditForm({...editForm, username: e.target.value})} value={editForm.username}/>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea rows={3} className='w-full p-3 border-gray-200 rounded-lg' placeholder='Please enter a short bio' onChange={(e)=>setEditForm({...editForm, bio: e.target.value})} value={editForm.bio}/>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" className='w-full p-3 border-gray-200 rounded-lg' placeholder='Please enter your location' onChange={(e)=>setEditForm({...editForm, location: e.target.value})} value={editForm.location}/>
                        </div>
