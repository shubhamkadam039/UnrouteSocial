        ...
        <div className='flex gap-4 pb-5'>
            ...
            {/* Story Cards */}
            {
                stories.map((story, index)=> (
                    <div key={index} className={'relative rounded-lg shadow min-w-30 max-w-30 max-h-40 cursor-pointer hover:shadow lg transition-all duration-200 bg-linear-to-b from-orange500 to=orange-600 hover:from-roange-700 to-orange-800 active:scale:95'}>
