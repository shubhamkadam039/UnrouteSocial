  ...
  return (
    ...
    >
       <div className="w-full px-6 pt-6">
        ...
        <Link to='/CreatePost' className='flex items-center justify-center gap-2 py-2.5 mt-6 mx-6 rounded-lg bg-linear-to-r from-orange-400 to-red-600 hover:from-orange-500 hover:to-red-700 active-scale-95 transition text-white cursor-pointer'>
